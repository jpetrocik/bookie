...
//            LOGGER.config(LocalizationMessages.BEAN_REGISTERED(beanName));
    ...
    private ApplicationContext createSpringContext() {
        ...
        if (springContext == null) {
            ...
            springContext = createAnnotationConfigApplicationContext(contextConfigLocation);
        }
        return springContext;
    }

    private ApplicationContext createAnnotationConfigApplicationContext(String packageScan) {
    	 AnnotationConfigApplicationContext ctx = new AnnotationConfigApplicationContext();
    	    ctx.scan(packageScan);
    	    ctx.refresh();
        return ctx;
    }
